                    ...
                    <form id="form_menu">
                        ...
                        <fieldset class="mb-3">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" name="menu_nama_ina" id="menu_nama_ina" value="{{ $data->menu_nama_ina }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" name="menu_nama_eng" id="menu_nama_eng" value="{{ $data->menu_nama_eng }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" name="menu_controller" value="{{ $data->menu_controller }}" readonly>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" name="menu_route_name" id="menu_route_name" value="{{ $data->menu_route_name }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" name="menu_folder_view" id="menu_folder_view" value="{{ $data->menu_folder_view }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="input-group col-lg-10">
                                    <input type="text" class="form-control" placeholder="Pilih icon" name="menu_icon" id="menu_icon" value="{{ $data->menu_icon }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" name="menu_order" id="menu_order" value="{{ $data->menu_order }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="checkbox" class="form-check-input form-check-input-switch" name="menu_publish_ke_user" id="menu_publish_ke_user" data-on-text="YA" data-off-text="TIDAK" data-on-color="primary" data-off-color="default" {{ ($data->menu_publish_ke_user == 'Y') ? 'checked' : '' }}>
                                </div>
                            </div>
                        </fieldset>
                        ...
                        <fieldset class="mb-3">
                            ...
                            @php
                                $coll_permission = collect($permissions_mapping);
                            @endphp
                            @foreach ($permissions as $r)
                                @php
                                    $exists = $coll_permission->where('perm_nama', $r->perm_nama)->first();
                                @endphp
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-2">{{ $r->perm_deskripsi }}</label>
                                    <div class="col-lg-10">
                                        <input type="checkbox"
                                                class="form-check-input form-check-input-switch"
                                                name="perm_nama[{{ $r->perm_nama }}]"
                                                id="perm_nama"
                                                data-on-text="YA"
                                                data-off-text="TIDAK"
                                                data-on-color="primary"
                                                data-off-color="default"
                                                {{ !empty($exists) ? 'checked' : '' }}>
                                    </div>
                                </div>
                            @endforeach
...
<script>
    ...
    $('document').ready(function(){
        list_menu_divider("{{ $data->menu_div_id }}");
    });
    ...
    function simpan_menu(){
        $.ajax({
            type: "PUT",
            url: "{{ route('menu-manager.update', $data->menu_id) }}",
            data: $('#form_menu').serialize(),
            beforeSend: function(){
                small_loader_open('section_menu');
            },
            success: function (s) {
                sw_success_redirect(s, "{{ route('menu-manager.index') }}");
            },
            error: function(e){
                if(e.status == 422){
                    sw_multi_error(e);
    ...
    function reload_divider_options(){
        $.ajax({
            ...
            complete: function(){
                ...
                $('#menu_div_id').val({{ $data->menu_div_id }});
                $('#menu_parent_id').val({{ $data->menu_parent_id }});
            }
        });
    }
    ...
    function list_menu_divider(i){
        $.ajax({
            ...
            success: function(s){
                ...
                $('#menu_parent_id').select2().select2('val', '{{ $data->menu_parent_id }}');
            },
            complete: function(){
